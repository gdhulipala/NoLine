...
/**
 * Created by ganga on 10/9/17.
 */

public class PayCursorAdapter extends CursorAdapter {

    private static final String LOG_TAG = InventoryCursorAdapter.class.getName();

    public PayCursorAdapter(Context context, Cursor c) {
        super(context, c, 0 /* flags */);
    }
    @Override
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        // Inflate a list item view using the layout specified in list_item.xml
        View listItem = LayoutInflater.from(context).inflate(R.layout.listitem_payactivity, parent, false);
        return listItem;
    }
