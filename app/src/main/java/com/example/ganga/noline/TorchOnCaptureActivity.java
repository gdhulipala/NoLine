...
public class TorchOnCaptureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (scanIntent.hasExtra(Constants.CAMERA_FLASH_ON)) {
            if (scanIntent.getBooleanExtra(Constants.CAMERA_FLASH_ON, false)) {
